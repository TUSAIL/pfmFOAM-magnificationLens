The TFM cases for unbouned fluidization simulations
...
The simulation parameters are in the paper.

To run the cases enter to each folder and type ./Allrun.parallel in the terminal.
